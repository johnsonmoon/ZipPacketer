package com.xuyihao.zip.packeter;
...
public class ZIPUtil {
     ...
     */
    public static boolean generateZipPackage(String zipFilePathName, List<String> containedFilePathName, List<String> containedFileName){
        boolean flag = false;
        try{
